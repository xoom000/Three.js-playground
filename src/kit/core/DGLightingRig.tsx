...
export function DGLightingRig({mobile=false,mode='cinematic'}:LightingProps){
 ...
 return <>
  ...
  <spotLight position={[-3.6,7,3.5]} angle={.72} penumbra={1} intensity={inspection?155:120} color="#ffe0b3" castShadow shadow-mapSize={[mobile?512:1536,mobile?512:1536]} shadow-bias={-.0001} shadow-normalBias={.02}/>
  ...
  <Environment resolution={mobile?48:128} frames={1} environmentIntensity={inspection?.9:.72}>
